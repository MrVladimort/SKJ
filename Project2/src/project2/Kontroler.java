...
public class Kontroler {
    private LinkedHashSet<String> agents = new LinkedHashSet<>();
        ...
        private Kontroler(int port) {
            MySuperNewMegaAddress address = new MySuperNewMegaAddress("localhost", port);
        ...
        private void server500() {
            try {
                while (true) {
                    ...
                    MySuperNewMegaAddress client = new MySuperNewMegaAddress(socket.getInetAddress().toString(), socket.getPort());
        ...
        private void sendRequest(String request, String host) throws IOException {
            MySuperNewMegaAddress address = new MySuperNewMegaAddress(host);
        ...
        private int getTime(String agent) {
            MySuperNewMegaAddress address = new MySuperNewMegaAddress(agent);
            try {
